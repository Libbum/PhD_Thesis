...
\subsection{Cluster Identification With Voronoi}
...
\xxx{This section may be cut depending on the results of the strain jobs}
...
Even if nothing maybe the spectrum changes a bit. 
...
\resizebox{\widefigure}{!}{\includestandalone{figures/tlsinjj}}
  \caption[Oxygen Properties in a Josephson Junction]{\label{fig:tlsinjj}Clusters in a JJ. \resizebox{0.5em}{!}{\includegraphics{figures/aluminium}} is there, so is \resizebox{0.5em}{!}{\includegraphics{figures/oxygen}}: it's a fucking party.}
\end{adjustwidth}
\end{figure}
