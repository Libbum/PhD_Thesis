...
\begin{figure}[htp]
  \centering
  %\includegraphics[width=\columnwidth]{spect3d}
...
\begin{figure}[htb]
  \centering
  %\includegraphics[width=\columnwidth]{lift.pdf}
...
\begin{figure}[htb]
  \centering
  %\includegraphics[width=\columnwidth]{harmlike}
  \caption{\label{fig:lineharm}Wavefunctions of an oxygen confined by six equidistant aluminium atoms at $\abs{X}\!=\!\abs{Y}\!=\!\abs{Z} = 1.6$ \AA. This configuration exhibits a unique ground state (as shown in the energy level diagram) and hence is considered to be spatially localised.}
\end{figure}
...
\begin{figure}[htb]
  \centering
  %\includegraphics[width=\columnwidth]{btype}
  \caption{\label{fig:lineb}Wavefunctions of an oxygen confined by six aluminium atoms, where the symmetry of \cref{fig:lineharm} has been broken. $\abs{X}\!=\!\abs{Z} = 1.6, \abs{Y} = 2.1$ \AA, which manifests as a B type defect.}
\end{figure}
...
\begin{figure}[htb]
  \centering
 % \includegraphics[width=\columnwidth]{atypez.pdf}
  \caption{\label{fig:atypez}Wavefunctions of an A type defect with confinement $\abs{X} = 1.53, \abs{Y} = 1.9, \abs{Z} = 1.95$ \AA\ which yields dominant dipole in the $z$ direction with a strength of $0.21 \; e$\AA. Leftmost axis shows an $xz$ projection of the first excited state to compare with \lin{2+1D} results in \onlinecite{DuBois2015}.}
  %TODO: Maybe merge this and atypey to allow two figures in corundum defect section (style only allows 8 figures)
\end{figure}
