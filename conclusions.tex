...
\Cref{ch:tlslow} probes the capabilities of the model in low dimensions (\lin{1D} and \lin{2D}), subsequently \cref{ch:tlsphase} expands the dimensionality of the model to \lin{2+1D} and compares its results to many current experimental strongly coupled TLS measurements in phase qubits.
