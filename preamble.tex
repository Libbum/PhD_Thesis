...
\OnehalfSpacing % before geometry, so that heightrounded works right.
...
\newcommand{\versoquote}[2]{
    ...
    \cleartoevenpage %TODO: Put in an override to ignore this when not needed.
    \thispagestyle{empty}
    \vspace*{\fill}
...
\renewcommand{\gitMark}{Branch\textrm{:} \gitBranch\,@\,\gitAbbrevHash}
