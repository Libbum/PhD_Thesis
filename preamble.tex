...
\setromanfont[Ligatures={TeX, Common}, Numbers=OldStyle]{Skolar PE} %TODO: Fix the \addfontfeature{x){y} -> {\addfontfeature{x)y} everywhere
...
\captionnamefont{\small\color{Set1-5-1}\addfontfeature{LetterSpace=5.0,Letters=SmallCaps}} \captiontitlefont{\small}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% EMPTY PAGE STYLES
%This should only be called before a chapter heading and only to fill a blank page probably...
\newcommand{\versoquote}[2]{
    ...
    \ifthenelse{\quotelength < \epigraphwidth}{%Quote is one line,smaller than box
        \addtolength{\quotelength}{-15pt} %TODO: Maybe override this to center the entire quote
...
\renewcommand{\gitMarkFormat}{\color{gray}\small\sansfont}
