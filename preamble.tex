...
\usepackage{tocbibind} % put things in the table of contents. %TODO: May be able to memoir native this
...
\renewcommand*{\cftchaptername}{SOMETHING }
\renewcommand{\cftchapteraftersnum}{::}
\renewcommand{\cftchapteraftersnumb}{\\}
%\renewcommand{\cftdot}{\ensuremath{--}}

% Chapter headings in the list of figures: TODO: May be able to native this.
\newcommand{\lofchap}[1]{%
