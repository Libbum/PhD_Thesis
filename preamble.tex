...
%TODO: Find out where hyperref is throwing unicode errors (its not in the bib, maybe the bst?)
\usepackage[xetex,final,\hyperoptions,hyperfootnotes=false,linktoc=all,pagebackref]{hyperref}
\usepackage{backref}
