...
\usepackage[mode=buildnew]{standalone} %-enable-write18 in pdflatex options
\usepackage{tikz}
\usepackage{pgfplots}
...
\sectionfont{\fontspec{Helvetica LT Std}\fontsize{15}{17}\selectfont}
\subsectionfont{\fontspec{Helvetica LT Std}\fontsize{13}{15}\selectfont}
...
\usepackage[Sonny]{fncychap} % TODO: Change this
    \ChNameVar{\Large\fontspec{Helvetica LT Std}\selectfont}
    \ChTitleVar{\Large\fontspec{Helvetica LT Std}\selectfont}
