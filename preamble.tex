...
%TODO: Should be able to use memoir to emulate this. Currently breaks if removed or warns if in use.
\usepackage[font={small},labelfont={bf},margin=15pt]{caption} % load after babel. also replaces hypcap.

\usepackage{threeparttable} %TODO: wtf
\usepackage{booktabs} %TODO: wtf
%\usepackage{csquotes}
\usepackage{textcase} %TODO: wtf
