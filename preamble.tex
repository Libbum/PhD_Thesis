...
\setmathsfont(Digits,Latin,Greek)[Numbers={Lining,Proportional}]{Minion Pro} %TODO: Can't get Angstrom symbol atm.
...
%\usepackage[markifdraft]{gitinfo2} %was working, now failing??? 
