...
In one dimension, this matrix is relatively straightforward to construct (outlined below), although higher dimensions require special treatment (see \cref{sec:methdipole,ch:threedee} for specifics).\xxx{Make sure I actually go into these details, or otherwise can this sentence}
