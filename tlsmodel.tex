...
The form of \cref{eq:cd26f} adheres to \cref{eq:cdgeneral}, where $\cramped{\Delta f_6^{\;(2)} = \frac{1}{180}2f_{-3}-27f_{-2}+270f_{-1}-490f_{0}+270f_{1}-27f_{2}+2f_{3}}$. Applying this equation is no different to \cref{eq:cd22f}, and the only additional overhead is the requirement of six absciss\ae\ rather than two.
...
\begin{align}
h_{opt,\mathcal{TE}} &= 1.563\ten{-2}\cdot0.046 = 7.181\ten{-4} \simeq 2^{-11} & \left[\text{Å}\right]\\
...
\section{Total Error and Maximum Step Range}

Now that the optimal step size $h_{opt}$ has been calculated, 