...
\chapterprecis{Derivation of a simple $n$D description of a delocalised oxygen atom embedded in a surrounding amorphous region of \ce{AlO_x}.}
...
An in-depth analysis of the numerical treatment of $\nabla^2$ follows in \crefrange{sec:numder}{sec:catoterr}, then finally an overview of the construction of the hamiltonian matrix and unit conversions in \xxx{The next sections}.
