...
Below in \cref{sec:hammat,ch:lowdims}, the need for calculating at least 6 excited state wavefunctions using direct matrix diagonalisation is presented.
...
\xxx{summarise chapter and outline}
...
In subsequent chapters we use this approach to ...