...
yielding a value for the condition error of $\epsilon = 1.530\ten{-18}$.\xxx{This is a value for the harmonic oscillator wavefunction. Can we connect it to SM? Otherwise this entire section is probably pointless. I'll continue like this doesn't matter and we'll discuss it later. Converting to real units isn't necessarily making sense atm either.}
