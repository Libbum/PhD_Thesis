...
There was no direct experimental evidence for magnetism in superconducting circuits until 2008 when unpaired surface spins in thin-film SQUIDs identified ~\cite{Sendelbach2008}.
...
The origin of these local magnetic moments as been proposed as multiple metal-induced gap states arising from localised disorder at the metal--oxide interface~\cite{Choi2009}.

\divtext

Andreev bound states~\cite{DeSousa2009}

\divtext

Kondo impurities~\cite{Faoro2007}

\divtext

TLS state dependence of the JJ transparency~\cite{Ku2005}
...
\xxx{flesh this out a bit more so the transition to material science investigation isn't so brutal}
