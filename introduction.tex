...
\caption[STM picture of a TLS]{STM representation of a TLS, a quantum mechanical description by wave functions \plotline{line width=1.5pt,color=Set1-5-1} \& \plotline{line width=1.5pt,color=Set1-5-2} in a double well potential \plotline{line width=1pt,black}. Excitation energies are calculated via $\cramped{E = \sqrt{\Delta^2+\epsilon^2}}$. }
\end{marginfigure}
...
\begin{figure}[htp]
\begin{adjustwidth*}{-\marginparwidth}{0em} %TODO: Make this figure out what page it's on
