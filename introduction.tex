...
This model is then rigourously compared to experimental results in \cref{ch:tlsphase}, applying at a \lin{2+1D} variant to explain the many interaction phenomena presently identified.
