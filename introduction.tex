...
\nomdef{ALC}{LC}{Inductor-Capacititor circuit, generates a harmonic oscillator}
...
Shadow evaporation is a common technique used to fabricate systems such as this, where two metallic layers are deposited from different angles with an intervening oxidation step (see \cref{fig:jjdiagram}).
...
\section[Noise and Phenomenological Theories]{Noise Sources and Phenomenological Theories}
