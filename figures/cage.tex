...
\draw (5,0.5,0) circle (0.25);
\draw (5,9.5,0) circle (0.25);
\draw (1.5,5,0) circle (0.25); %0.625
\draw (8.5,5,0) circle (0.25); %9.375
\draw (5,5,-3.5) circle (0.25);
\draw (5,5,3.5) circle (0.25);
\node at (5,0.5,0) {\includegraphics[width=1.4em]{aluminium}};
\node at (5,9.5,0) {\includegraphics[width=1.4em]{aluminium}};
\node at (1.5,5,0) {\includegraphics[width=1.4em]{aluminium}};
\node at (8.5,5,0) {\includegraphics[width=1.4em]{aluminium}};
\node at (5,5,-3.5) {\includegraphics[width=1.4em]{aluminium}};
\node at (5,5,3.5) {\includegraphics[width=1.4em]{aluminium}};
%labels
