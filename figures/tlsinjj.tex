...
\pgftext{\includegraphics[scale=0.8]{vors}};
...
\begin{scope}[yscale=3,xshift=-9cm,yshift=3.75cm]
    %large3 (purple)
...
\begin{scope}[yscale=3,xshift=-2cm,yshift=3.75cm]
    %large4 (orange)
...
\begin{scope}[yscale=3,xshift=5cm,yshift=3.75cm]
    %large5 (yellow)
...
\begin{scope}[yscale=3,xshift=-9cm,yshift=-4.75cm]
    %ASYM (RED) Complete
...
\begin{scope}[yscale=3,xshift=-2cm,yshift=-4.75cm]
    %large1 (green)
...
\begin{scope}[yscale=3,xshift=5cm,yshift=-4.75cm]
    %large1 (blue)
