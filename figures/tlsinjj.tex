...
\begin{scope}[yscale=3,xshift=10cm,yshift=1.9cm]
    %large4 (orange)
...
\begin{scope}[yscale=3,xshift=10cm,yshift=0.3cm]
    %large5 (yellow)
...
\begin{scope}[yscale=3,xshift=10cm,yshift=-1.3cm]
    %ASYM (RED) Complete
...
\begin{scope}[yscale=3,xshift=10cm,yshift=-2.9cm]
    %large1 (green)
...
\begin{scope}[yscale=3,xshift=10cm,yshift=-4.5cm]
    %large1 (blue)
