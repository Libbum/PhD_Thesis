...
\xxx{Jared suggests that the physics of the model isn't discussed in enough depth here but when changes to sec 1.7.1 are done reference back to that and it will be better}
