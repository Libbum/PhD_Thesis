...
Ignoring many technical intricacies, a first order approximation to the required memory footprint just to store the numbers of a \lin{2D} plane, $9$ Å$^\text{\skolarlining 2}$ in area discretised via $h_{opt}$ requires $294,913^2$ double precision floats.
