...
\lofchap{TLS Parameter Space In Low Dimensions}
...
\xxx{Split chapters. See jared's hardcopy}
...
\xxx{Add here or in discussion of the model the PRL discussion on quasi-degenerate. See jareds notes}
